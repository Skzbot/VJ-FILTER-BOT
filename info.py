...
API_ID = int(environ.get('API_ID', '24286057'))
API_HASH = environ.get('API_HASH', '9ab62f8268f1c5a60b2808f06f2ad2c9')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6131352075').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001977606863').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', '7f959dea87af1ca313472f63eb46d1a42710958e')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001954311684'))
...
URL = "https://vj-filter-bots.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bots.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-bots.onrender.com/".format(FQDN)
else:
    URL = "https://vj-filter-bots.onrender.com/".format(FQDN)
